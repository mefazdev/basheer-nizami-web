...
import { ArticleGrid } from "@/app/(public)/articles/ArticleGrid";
...
export const HomeArticles = ({}) => {
 ...
 const { articles } = useHomepageContent()
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5">
        ...
        >
          ...
          <h2 onClick={()=>console.log(articles)} className="text-3xl lg:text-5xl    font-bold text-gray-900 mb-3 lg:mb-6">
            Articles
          </h2>
